...
app.use(require('./routes/chofer.router'))
app.use(require('./routes/contacto_terminal.route'))
app.use(require('./routes/empleado.route'))
app.use(require('./routes/reserva_ticket.route'))
app.use(require('./routes/roles.route'))
app.use(require('./routes/ruta.route'))
app.use(require('./routes/terminal.router'))
app.use(require('./routes/venta_ticket.route'))
